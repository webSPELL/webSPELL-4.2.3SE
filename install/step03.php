     ...
     <tr align="left" valign="top">
      ...
      <table align="center" border="0" width="100%">
        ...
        <tr>
         ...
         $chmodfiles = Array('_mysql.php','_stylesheet.css','downloads/','images/articles-pics','images/avatars','images/banner','images/bannerrotation','images/flags','images/gallery/large','images/gallery/thumb','images/icons/ranks','images/links','images/linkus','images/news-pics','images/news-rubrics','images/partners','images/smileys','images/sponsors','images/squadicons','images/userpics','tmp/');
         sort($chmodfiles);
         $error = array();
