...
<head>
	...
	<title><?php echo $myclanname ?> - webSPELL Society Edition - AdminCenter</title>
  ...
  <tr>
   ...
   <div id="menu">
    ...
    <ul>
      ...
      <li><a href="admincenter.php?site=registerfields"><?php echo $_language->module['register_fields']; ?></a></li>
      <li><a href="admincenter.php?site=data"><?php echo $_language->module['databases']; ?></a></li>
    </ul>
    <?php } if(ispageadmin($userID)) { ?>
    ...
    <ul>
      ...
      <li><a href="admincenter.php?site=navigation"><?php echo $_language->module['navigation']; ?></a></li>
      <li><a href="admincenter.php?site=modules"><?php echo $_language->module['modules']; ?></a></li>
      <li><a href="admincenter.php?site=modules_boxed"><?php echo $_language->module['modules_boxed']; ?></a></li>
      <li><a href="admincenter.php?site=styles"><?php echo $_language->module['styles']; ?></a></li>
      <li><a href="admincenter.php?site=icons"><?php echo $_language->module['icons']; ?></a></li>
    ...
    <h2>&not; <?php echo $_language->module['access_limitations']; ?></h2>
    <ul>
      <li><a href="admincenter.php?site=accessgroups"><?php echo $_language->module['access_groups']; ?></a></li>
