...
if(isset($_GET['action']) and $_GET['action'] == "edit") {
  ...
  eval ("\$addflags = \"".gettemplate("flags_admin", "html", "admin")."\";");
	...
	if($anz) {
      ...
      <tr>
        ...
        <td><input type="text" name="position['.$ds['sqmID'].']" value="'.htmlspecialchars($ds['position']).'" size="60" />'.$activity.'</td>						   
      </tr>';
		}
	}
	...
	if(isdbauthor($id)) $dbauthor='<input type="checkbox" name="dbauthor" value="1" onmouseover="showWMTT(\'id14\')" onmouseout="hideWMTT()" checked="checked" />';
	else $dbauthor='<input type="checkbox" name="dbauthor" value="1" onmouseover="showWMTT(\'id14\')" onmouseout="hideWMTT()" />';
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      ...
      <td>'.$dbauthor.' '.$_language->module['dbauthor'].'</td>
    </tr>
    <tr>
