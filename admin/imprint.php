...
if(isset($_POST['submit'])) {
  ...
  echo '<br /><textarea id="message" name="message" rows="30" cols="" style="width: 100%;">'.htmlspecialchars($ds['imprint']).'</textarea><br /><br /><input type="hidden" name="captcha_hash" value="'.$hash.'" />
