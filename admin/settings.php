...
if(isset($_POST['submit'])) {
	...
	if($CAPCLASS->check_captcha(0, $_POST['captcha_hash'])) {
		safe_query("UPDATE ".PREFIX."settings SET hpurl='".$_POST['url']."',
									 ...
									 maxboxmodules='".$_POST['maxboxmodules']."',
...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
  <tr>
    ...
    <td width="35%"><input name="title" type="text" value="<?php echo htmlspecialchars($dt['title']); ?>" size="35" onmouseover="showWMTT('id2')" onmouseout="hideWMTT()" /></td>
    <td width="15%"><b><?php echo $_language->module['page_url']; ?></b></td>
    <td width="35%"><input type="text" name="url" value="<?php echo $ds['hpurl']; ?>" size="35" onmouseover="showWMTT('id1')" onmouseout="hideWMTT()" /></td>
  </tr>
  <tr>
    <td><b><?php echo $_language->module['clan_name']; ?></b></td>
    <td><input type="text" name="clanname" value="<?php echo htmlspecialchars($ds['clanname']); ?>" size="35" onmouseover="showWMTT('id3')" onmouseout="hideWMTT()" /></td>
    <td><b><?php echo $_language->module['clan_tag']; ?></b></td>
    <td><input type="text" name="clantag" value="<?php echo htmlspecialchars($ds['clantag']); ?>" size="35" onmouseover="showWMTT('id4')" onmouseout="hideWMTT()" /></td>
  </tr>
  <tr>
    <td><b><?php echo $_language->module['admin_name']; ?></b></td>
    <td><input type="text" name="admname" value="<?php echo htmlspecialchars($ds['adminname']); ?>" size="35" onmouseover="showWMTT('id5')" onmouseout="hideWMTT()" /></td>
    <td><b><?php echo $_language->module['admin_email']; ?></b></td>
    <td><input type="text" name="admmail" value="<?php echo $ds['adminemail']; ?>" size="35" onmouseover="showWMTT('id6')" onmouseout="hideWMTT()" /></td>
  </tr>
</table>
<br /><br />
<table width="100%" border="0" cellspacing="1" cellpadding="3">
...
<div style="width: 45%;float: left;">
	<table width="100%" border="0" cellspacing="1" cellpadding="3">
	  <tr>
	    <td width="50%"><b><?php echo $_language->module['modules']; ?>:</b></td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td align="right"><input type="text" name="maxboxmodules" value="<?php echo $ds['maxboxmodules']; ?>" size="3" onmouseover="showWMTT('id28')" onmouseout="hideWMTT()" /></td>
	    <td><?php echo $_language->module['maxboxmodules']; ?></td>
	  </tr>
  </table>
</div>
